import { Annotation } from '@react-form-builder/core';
import { BuilderView } from '@react-form-builder/core';
import { ComponentData } from '@react-form-builder/core';
import { ComponentPropertyComputeType } from '@react-form-builder/core';
import { ComponentType } from 'react';
import type { CSSProperties } from 'react';
import { EditorType } from '@react-form-builder/core';
import { FormEventHandler } from 'react';
import { FormViewerProps } from '@react-form-builder/core';
import type { ForwardedRef } from 'react';
import type { IconProps } from '@rsuite/icons/lib/Icon.js';
...
import { Language } from '@react-form-builder/core';
 ...
 */
export declare const ActionCell: ({ rowData, rowIndex, onAction, icon, ...props }: ActionCellProps) => JSX_2.Element;
 ...
 * @returns the React element.
 */
export declare const CheckCell: ({ rowData, dataKey, rowIndex, onChange, ...props }: InputCellProps) => JSX_2.Element;
 ...
 */
declare type ComputePropertiesParameters = {
    /**
     * Function parameters.
     */
    function: never;
 ...
 * @template T the component property value type.
 */
declare type ComputeTypeParams<T extends ComponentPropertyComputeType> = ComputePropertiesParameters[T];
 ...
 * @returns the React element.
 */
export declare const EditableTable: (props: EditableTableProps) => JSX_2.Element;
...
export declare const FormBuilder: (props: FormBuilderProps) => JSX_2.Element;
 ...
 * @returns the React element.
 */
export declare const InputCell: ({ rowData, dataKey, rowIndex, ...props }: InputCellProps) => JSX_2.Element;
 ...
 */
declare type LocalizationComputeCodeParams = {
    /**
 ...
 */
export declare const makeColumns: (columns: ColumnDescription[]) => JSX_2.Element[];
 ...
 * @returns the React element.
 */
export declare const SelectCell: ({ rowData, dataKey, rowIndex, options, onChange, ...props }: SelectCellProps) => JSX_2.Element;
